...
본 개인정보처리방침은 회사가 운영하는 모바일 게임 "Mochi Jump"에 적용됩니다. 본 서비스는 **전체 이용가**로 출시되며, 어린이도 안전하게 플레이할 수 있도록 다음 법령 및 가이드라인을 준수합니다.
...
본 서비스는 전체 이용가로 출시되며, 어린이도 안전하게 플레이할 수 있도록 다음과 같은 강화된 보호 절차를 운영합니다.
